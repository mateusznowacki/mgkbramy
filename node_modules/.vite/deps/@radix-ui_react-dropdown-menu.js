...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React15.useRef(false);
  ...
  return (0, import_jsx_runtime5.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime5.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
      ...
      children: (0, import_jsx_runtime5.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React15.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, container, children }) }) });
};
MenuPortal.displayName = PORTAL_NAME;
var CONTENT_NAME = "MenuContent";
var [MenuContentProvider, useMenuContentContext] = createMenuContext(CONTENT_NAME);
var MenuContent = React15.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(CONTENT_NAME, props.__scopeMenu);
    return (0, import_jsx_runtime5.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime5.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime5.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
var MenuRootContentModal = React15.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React15.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime5.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React15.useState(null);
    const contentRef = React15.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React15.useRef(0);
    const searchRef = React15.useRef("");
    const pointerGraceTimerRef = React15.useRef(0);
    const pointerGraceIntentRef = React15.useRef(null);
    const pointerDirRef = React15.useRef("right");
    const lastPointerXRef = React15.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React15.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React15.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime5.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React15.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React15.useCallback(
          (event) => {
            var _a;
        ...
        onTriggerLeave: React15.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: React15.useCallback((intent) => {
...
var MenuGroup = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React15.useState("");
    React15.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React15.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React15.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime5.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenuSubTrigger = React15.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React15.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React15.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React15.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React15.useEffect(() => {
...
var MenuSubContent = React15.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
    ...
    const ref = React15.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime5.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime5.jsx)(
      MenuContentImpl,
      {
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime6.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime6.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
DropdownMenu.displayName = DROPDOWN_MENU_NAME;
var TRIGGER_NAME = "DropdownMenuTrigger";
var DropdownMenuTrigger = React16.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React16.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React16.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React16.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React16.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React16.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React16.forwardRef((props, forwardedRef) => {
